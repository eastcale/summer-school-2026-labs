...
In the asymptotic limit (large *n* or $n$) for a chemically homogenous medium, this spacing is approximately a constant for all *n*. This is what we observed when we plotted $\Delta \Pi_{1}$ vs. $\Pi_{n, 1}$ for our zero-age main-sequence (ZAMS) model in Lab 1. At the ZAMS, at the start of hydrogen ignition, `MESA` begins with a chemically homogenous mixture, so for sufficiently high *n*, the asymptotic relation behaves as expected.